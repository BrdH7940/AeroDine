        ...
        <div className="mt-6">
          ...
          <div className="mt-6">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-2 px-4 border border-[#8A9A5B]/30 rounded-md shadow-sm bg-white text-sm font-medium text-[#36454F] hover:bg-[#F9F7F2] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#8A9A5B] transition-colors"
            >
              <svg 
                className="w-5 h-5" 
                fill="none" 
